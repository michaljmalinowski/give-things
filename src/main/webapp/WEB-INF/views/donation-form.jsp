        ...
        <form action="" method="post">
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Liczba 60l worków:
                        <input id="bags" type="number" name="quantity" step="1" min="1"/>
                    </label>
                </div>
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label>
                                Adres e-mail <input type="email" name="email"/>
                            </label>
                        </div>
                    </div>
...
<script src="<c:url value="/resources/js/donation_form.js"/>"></script>
</body>
</html>

//atrybut value jako dodatek przy sprawdzaniu wprowadzonych (input) -> model -> zapamięta wartość
//dodać id do części inputów